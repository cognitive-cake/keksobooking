...
// Пробовал написать функцию, но так и не понял, зачем передавать массивы со значениями. Я ведь работаю с селектами и мне нужен только порядковый номер опции для синхронизации. Решил не продолжать дальше самостоятельно, а дождаться сл. интенсива по JS
